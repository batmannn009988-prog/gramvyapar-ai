...
OPPORTUNITIES = [
    {
        ...
        "risk_fit": 90,
        "why": (
            "Tailoring shows a relatively strong balance of "
            "local demand, competition, capital fit and risk "
            "fit in this prototype."
        ),
    },

    {
        ...
        "risk_fit": 84,
        "why": (
            "Repair Services shows a relatively strong balance "
            "of local demand, competition, capital fit and "
            "risk fit in this prototype."
        ),
    },

    {
        ...
        "risk_fit": 78,
        "why": (
            "Handicrafts shows a relatively strong balance of "
            "local demand, competition, capital fit and risk "
            "fit in this prototype."
        ),
    },
...
# ============================================================
# FRAME 3 — SUMMARY CARD
# ============================================================

def render_frame3_summary_card(
    title,
    main_value,
    small_value,
):
    ...
    st.markdown(
        f"""
        <div class="gv3-summary-card">

            <div class="gv3-summary-title">
                {title}
            </div>

            <div class="gv3-summary-main">
                {main_value}
            </div>

            <div class="gv3-summary-small">
                {small_value}
            </div>
...
def render_fit_bar(
    ...
    st.markdown(
        f"""
        <div class="gv3-fit-row">

            <div class="gv3-fit-label">
                {label}
            </div>

            <div class="gv3-fit-track">
                <div
                    class="gv3-fit-fill"
                    style="width: {value}%;">
                </div>
...
def render_opportunity_card(
    ...
    st.markdown(
        f"""
        <div class="gv3-opportunity-card {top_class}">

            <div class="gv3-opportunity-top">

                <div class="gv3-opportunity-left">

                    <div class="gv3-opportunity-rank">
                        {rank}
                    </div>

                    <div>

                        <div class="gv3-opportunity-name">
                            {opportunity["name"]}
                        </div>

                        <div class="gv3-opportunity-score-text">
                            {t("opportunity_score")}: 
                ...
                <div class="gv3-score-box">

                    <div class="gv3-score-number">
                        {opportunity["score"]}
                    </div>

                    <div class="gv3-score-label">
                        / 100
                    </div>
    ...
    render_fit_bar(
        t("skill_fit"),
        opportunity["skill_fit"],
    )

    render_fit_bar(
        t("capital_fit"),
        opportunity["capital_fit"],
    )

    render_fit_bar(
        t("risk_fit"),
        opportunity["risk_fit"],
    )
    ...
    st.markdown(
        f"""
            ...
            <div class="gv3-confidence">
                {t("confidence")}: 
                {t("prototype_estimate")}
            </div>
...
def render_frame_3():
    ...
    st.markdown(
        f"""
        <div class="gv3-page-title">
            {t("opportunity_title")}
        </div>

        <div class="gv3-page-subtitle">
    ...
    local_body = st.session_state.local_body
    ...
    with summary1:
        ...
        render_frame3_summary_card(
            t("profile_summary"),
            f"₹{capital:,.0f}",
            f"{experience} {t('years_experience')}",
        )
    ...
    st.markdown(
        f"""
        <div class="gv3-disclaimer">
            ⚠️ {t("prototype_disclaimer")}
        </div>
        """,
        unsafe_allow_html=True,
    )
